...
<link rel="stylesheet" type="text/css"
	href="CSS/styles/product_responsive.css">
<!-- cart -->
<link rel="stylesheet" type="text/css" href="CSS/styles/cart.css">
<link rel="stylesheet" type="text/css"
	href="CSS/styles/cart_responsive.css">
<!-- Categories -->
<link rel="stylesheet" type="text/css" href="CSS/styles/categories.css">
<link rel="stylesheet" type="text/css"
	href="CSS/styles/categories_responsive.css">
<!-- Checkout -->
<link rel="stylesheet" type="text/css" href="CSS/styles/checkout.css">
<link rel="stylesheet" type="text/css"
	href="CSS/styles/checkout_responsive.css">
<!-- Contact -->
...
<body>
	<div class="super_container">
		...
		<div class="container">
			...
			<jsp:include page="ViewAjax/buyerPwd.jsp"></jsp:include>
	...
	<!-- cart -->
	<script src="CSS/js/cart.js"></script>
	<!-- Categories -->
	<script src="CSS/js/categories.js"></script>
	<!-- Checkout -->
	<script src="CSS/js/checkout.js"></script>
	<!-- Contact -->
