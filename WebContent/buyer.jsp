...
<script src="CSS/BSjs/buyer.js?201910172217"></script>
</head>
<body>
	<div class="super_container">
		...
		<jsp:setProperty name="memberItems" property="isBuyer" value="true"></jsp:setProperty>
		...
		<div class="contact BShome">
			<div class="container">
				<div class="row">
					...
					<!-- 右側 nav Child -->
					<jsp:include page="View/navBuyer.jsp"></jsp:include>
				</div>
			</div>
		</div>
	</div>
